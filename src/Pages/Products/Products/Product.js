...
const Product = ({ product }) => {
    const { _id, image, sellerName, productName, resalePrice, origianlPrice, yearsOfUse, date } = product;
            ...
            <div className="rounded-md shadow-md sm:w-96 bg-gray-50 text-gray-800">
                ...
                <div className="p-3">
                    ...
                    <div className="space-y-3">
                        ...
                        <input type="text" placeholder="Add a comment..." className="w-full py-0.5 bg-transparent border-none rounded text-sm pl-0 text-gray-800" />
                    </div>
                </div>
            </div>
        </div>
