...
const Login = () => {
    ...
    const handleGithubLogin = () => {
        socialMediaLogin(githubAuthProvider)
            .then(result => {
                const userInfo = result.user;
                const user = {
                    name: userInfo?.displayName,
        ...
        <div className='flex justify-center'>
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-50 text-gray-800">
                ...
                <div className="my-6 space-y-4">
                    ...
                    <button onClick={handleGithubLogin} className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-600 focus:ring-emerald-600 hover:bg-black hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
